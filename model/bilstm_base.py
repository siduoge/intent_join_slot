...
class bilstm_base(object):
    ...
    def seq_loss(self):
        with tf.name_scope("loss"):
            ...
            self.slots_label = tf.Print(self.slots_label, ["self.slots_label", self.slots_label], summarize=100000)
